...
$manuscript_res_format = $params['format'];

// Allowed file extensions
$valid_extensions = ['png', 'gif', 'jpg', 'jpeg', 'xml'];
                ...
                if (isset($manuscript_page) && $manuscript_page === $page) {
                    ...
                    foreach ($manuscript['content'] as $file) {
                        ...
                        if (stripos($file, $sub_folder) !== false) {
                            ...
                            if (in_array($file_extension, $valid_extensions) && $file_extension === $manuscript_res_format && stripos($file, 'partner') === false) {
